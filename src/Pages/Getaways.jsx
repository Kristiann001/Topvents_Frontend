...
function Getaways() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-teal-600 to-cyan-700 text-white py-20 px-4 sm:px-6 text-center overflow-hidden">
        <div className="absolute inset-0 bg-black/10"></div>
        <div className="relative z-10 max-w-3xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 tracking-tight">
            Holiday Getaways
          </h1>
          <p className="text-lg sm:text-xl text-teal-100 mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          <SearchInput onSearch={setSearch} placeholder="Search destinations..." />
        </div>
      </div>
      ...
      <div className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 py-12 w-full">
        <div className="mb-8 flex items-center justify-between">
          ...
          {getaways.length > 0 && (
            <span className="text-gray-500 text-sm font-medium">
              Showing {getaways.length} results
            </span>
          )}
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-gray-500 text-lg">No getaways found matching criteria</p>
            <button 
              onClick={() => setSearch("")}
